...
var configs = {
    ...
    format: function (key, query) {
        var urlData = this[key];
...
exports.ranking = function (req, res) {
    request(configs.format("ranking", req.query), function (error, response, body) {
...
exports.rankingList = function (req, res) {
    request(configs.format("rankingList", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    });
...
exports.singers = function (req, res) {
    request(configs.format("singers", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    });
...
exports.search = function (req, res) {
    request(configs.format("search", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    })
...
exports.songs = function (req, res) {
    request(configs.format("songs", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    });
...
exports.music = function (req, res) {
    request(configs.format("music", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    });
...
exports.lrc = function (req, res) {
    request(configs.format("lrc", req.query), function (error, response, body) {
        if (!error && response.statusCode == 200) {
            res.end(body.trim());
        }
    });
